...
{
    public partial class VisorChoferes : Form
    {
        Form fh;
        int control = 0;
        public VisorChoferes()
        {
            InitializeComponent();
        }
        ...
        {
            AbrirFormularios(new AgregarChofer());
        ...
        private void VisorChoferes_Load(object sender, EventArgs e)
        {
            AbrirFormularios(new ListaDeChoferes());
